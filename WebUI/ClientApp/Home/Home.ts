...
namespace Home {
    ...
    let url = 'http://barbersystemdb.gear.host';

    var TR_Type = "1";
    var Insert_Type;
    var AccountType: Number = 1;
    var MSG_ID: number;
    var Details_Employee: Array<Employee> = new Array<Employee>();
    var Details_API: Array<Reservations> = new Array<Reservations>();
    ...
    var index;
    //Selecteditem
    var Selecteditem: Array<Reservations>;
    ...
    function DriverDoubleClick() {
        ...
        Selecteditem = Details_API.filter(x => x.Id == Number(ReportGrid.SelectedKey));
    ...
    function _SearchBox_Change() {
        ...
        if (searchbutmemreport.value != "") {
            ...
            SearchDetails = Details_API.filter(x => x.TurnNumber.toString().search(search) >= 0 || x.ClientName.toLowerCase().search(search) >= 0 /*|| x.PhoneNumber.toLowerCase().search(search) >= 0*/);
    ...
    function Display() {
        debugger;
        Close_div();
        Details_API = new Array<Reservations>();
    ...
    function Disbly_Emb() {
        ...
        debugger
        $("#div_Emb").html("");
        Details_Employee = new Array<Employee>();
        Ajax.Callsync({
            type: "Get",
            ...
            success: (d) => {
                debugger;
                let result = d as BaseReservations;     
                Details_Employee = result.Emps as Array<Employee>;
        ...
        if (veid != 1) {
            ...
            Ajax.Callsync({
                ...
                success: (d) => {
                    ...
                    let Index = Details_API.length - 1;
    ...
    function Corse_Is_Active(id_Corse: number, Details: Array<Reservations>, i: number) {
